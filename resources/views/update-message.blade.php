...
@section('title_doc')Обновление записи@endsection
...
@section('content')
    ...
    <form action="{{ route('contact-update-submit', $data->id)  }}" method="post">
        ...
        <div class="form-group">
            ...
            <textarea type="text" name="message" placeholder="Сообщение" id="message" class="form-control">{{ $data->message }}</textarea>
        </div>
